      ...
      class ValidParams
        ...
        def call
          if status_route?
            ...
            context.fail!(message: result_params.message, status: result_params.status) unless result_params.success?
            ...
            context.fail!(message: result_token.message, status: result_token.status) unless result_token.success?
          end
        end
